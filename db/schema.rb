...
ActiveRecord::Schema.define(version: 20151116185405) do
  ...
  add_index "idea_members", ["idea_id"], name: "index_idea_members_on_idea_id", using: :btree
  add_index "idea_members", ["user_id"], name: "index_idea_members_on_user_id", using: :btree
